...
define gui.choice_button_width = 830
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(105, 6, 105, 6)
...
define gui.slot_button_height = 217
...
define config.thumbnail_width = 269
...
define gui.confirm_frame_borders = Borders(42, 42, 42, 42)

## Рамки, используемые в частях экрана пропуска.
define gui.skip_frame_borders = Borders(17, 6, 53, 6)

## Рамки, используемые в частях экрана уведомлений.
define gui.notify_frame_borders = Borders(17, 6, 42, 6)
...
## персонажа.
define gui.history_name_xpos = 163
define gui.history_name_ypos = 0
define gui.history_name_width = 163
define gui.history_name_xalign = 1.0

## Местоположение, ширина и выравнивание диалогового текста.
define gui.history_text_xpos = 179
define gui.history_text_ypos = 3
define gui.history_text_width = 777
...
## Местоположение, ширина и выравнивание заголовка, показывающего имя говорящего
## персонажа.
define gui.nvl_name_xpos = 452
define gui.nvl_name_ypos = 0
define gui.nvl_name_width = 158
define gui.nvl_name_xalign = 1.0

## Местоположение, ширина и выравнивание диалогового текста.
define gui.nvl_text_xpos = 473
...
define gui.nvl_thought_xpos = 252
define gui.nvl_thought_ypos = 0
define gui.nvl_thought_width = 819
define gui.nvl_thought_xalign = 0.0

## Местоположение кнопок меню NVL.
define gui.nvl_button_xpos = 473
...
init python:
    ...
    def touch():
        ...
        gui.quick_button_borders = Borders(42, 15, 42, 0)
    ...
    def small():
        ...
        gui.textbox_height = 252
        gui.name_xpos = 84
        gui.dialogue_xpos = 95
        gui.dialogue_width = 1155

        ## Изменяет размеры и интервалы различных объектов.
        gui.slider_size = 38

        gui.choice_button_width = 1302
        ...
        gui.nvl_name_width = 321
        gui.nvl_name_xpos = 342

        gui.nvl_text_width = 961
        gui.nvl_text_xpos = 363
        gui.nvl_text_ypos = 6

        gui.nvl_thought_width = 1302
        gui.nvl_thought_xpos = 21

        gui.nvl_button_width = 1302
